    ...
    <div className="flex-1 flex flex-col items-center justify-center bg-white p-6 md:p-12">
      <div className="max-w-3xl text-center space-y-8">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-neutral-900">
          Simplify your{" "}
          <span className="text-neutral-500">Salary Management</span>
        </h1>
        <p className="text-lg md:text-xl text-neutral-600 max-w-2xl mx-auto leading-relaxed">
          The all-in-one platform to manage employee compensation, analyze
          salary trends, and gain actionable insights for your organization.
        </p>
        ...
        <div className="grid sm:grid-cols-2 gap-8 pt-16">
          <div className="flex flex-col items-center p-6 bg-neutral-50 rounded-2xl border border-neutral-100">
            ...
            <p className="text-neutral-500 text-sm">
              Easily track and manage all employee information in one secure
              location.
            </p>
          </div>
          <div className="flex flex-col items-center p-6 bg-neutral-50 rounded-2xl border border-neutral-100">
            ...
            <p className="text-neutral-500 text-sm">
              Generate comprehensive reports and visualize salary distributions
              effortlessly.
            </p>
          </div>
        </div>
